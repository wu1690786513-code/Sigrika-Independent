...
export const site = {
  ...
  avatar: "https://weavatar.com/avatar/bc0dba25ea5949e8290d012e081ceec669aa7784c7ad765173473c80cbaee404",
  email: "2091932928@qq.com",
};

{/* ========= 注意事项 ========== */}

export const notes = [
  { title: "站点要求", content: "站点含二次元相关元素，不限 IP 题材，站点可正常访问并持续维护更新" },
  ...
  { title: "更新要求", content: "为保障本站友链板块的活跃度，半年及以上无内容或动态更新将移除友链" },
];
